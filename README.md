...
Implementasi komponen Activity dengan pembuatan aplikasi penghitung volume balok.

<p align="center"><img src="https://github.com/harisfi/BarVolume/blob/master/2020111214093503dda7b8f1cca71a79fc9c6efe54094e.png?raw=true" width="250"/></p>
...
1. Clone the repo
   ```sh
   git clone https://github.com/harisfi/BarVolume.git
   ```
